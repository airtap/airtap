...
module.exports = function (config, cb) {
  ...
  // framework files
  var frameworkDir = path.resolve(__dirname, '../frameworks/tape')
  app.use('/__zuul', express.static(frameworkDir))
  ...
  clientBundler.require(path.join(frameworkDir, '/client.js'), { entry: true })
