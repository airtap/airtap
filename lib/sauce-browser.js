...
SauceBrowser.prototype._pingpong = function () {
  this._pingTimer = setInterval(() => {
    // TODO: how/when does this happen?
    if (this._pingTimer === null) return this.debug('cannot ping, stopped')
    if (!this._webdriver) return this.debug('cannot ping, no webdriver')
